...
async function getTopDistricts(n = 10) {
  const url = `https://services7.arcgis.com/mOBPykOjAyBO2ZKk/arcgis/rest/services/RKI_Landkreisdaten/FeatureServer/0/query?where=1%3D1&outFields=GEN,BEZ,cases7_per_100k,EWZ,bl&returnGeometry=false&f=json`;
